...
begin
  ...
  xSalarioFinal:= xSalario + (xValor_Vendas * 0.15);

  label4.Caption:= 'Nome: ' + xNome;
  label5.Caption:='Salário Fixo: R$' + FormatFloat('0.##', xSalario);
  label6.Caption:='Salário Final: R$' + FormatFloat('0.##',xSalarioFinal);
