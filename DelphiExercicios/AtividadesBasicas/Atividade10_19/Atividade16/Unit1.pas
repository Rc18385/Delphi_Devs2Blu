...
begin
  ...
  if (xMedia >= 7) then
    label5.Caption:= 'Aluno: ' + xNome + ' Foi Aprovado, Média: ' + FormatFloat('0.00' , xMedia)
  else if (xMedia > 5.09) and (xMedia <= 6.9) then
    label5.Caption:= 'Aluno: ' + xNome + ' Está em Recuperação, Média: ' + FormatFloat('0.00' , xMedia)
  else
    label5.Caption:= 'Aluno: ' + ' Foi Reprovado, Média: ' + FormatFloat('0.00' , xMedia)
end;
