...
begin
  ...
  begin
      ...
      if (AnsiLowerCase(xSexo[I]) = 'h') then
        xHomem := xHomem + 1
      else if (AnsiUpperCase(xSexo[I]) = 'F') then
        xMulher := xMulher + 1
      else
  ...
  label3.Caption:= 'Sexos Invalidos: ' + IntToStr(xInvalidos);
end;
